...
const (
	...
	prysmValidatorCommandPath      = file.ClientsDir + "/prysm/validator"
	...
	tekuCommandPath                = file.ClientsDir + "/teku/bin/teku"
	tekuValidatorCommandPath       = file.ClientsDir + "/teku/bin/teku"
	nethermindCommandPath          = file.ClientsDir + "/nethermind/nethermind"
	besuCommandPath                = file.ClientsDir + "/besu/bin/besu"
	nimbus2CommandPath             = file.ClientsDir + "/nimbus2/build/nimbus_beacon_node"
	nimbus2ValidatorCommandPath    = file.ClientsDir + "/nimbus2/build/nimbus_validator_client"
