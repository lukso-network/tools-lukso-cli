...
usage() {
  ...
  echo "    - A lukso component package"
...
productbuild --synthesize --package lukso-component.pkg --product "$archplist" lukso_raw.dist
...
productbuild --distribution lukso.dist --resources "$resources" --package-path "$component_package" lukso-unsigned.pkg
