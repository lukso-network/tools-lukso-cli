...
var (
	...
	errDepositNotProvided   = errors.New("⚠️  You need to provide a deposit data to send your deposit ")
	errProcessNotFound      = errors.New("⚠️  Process not found ")
	errIndexOutOfBounds     = errors.New("⚠️  Starting index out of bounds ")
	errTransactionFailed    = errors.New("⚠️  Transaction failed ")
